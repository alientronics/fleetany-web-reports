...
@section('header')
      ...
      <span class="mdl-layout-title">{{Lang::get("webreports.TiresMaintenance")}}</span>

@stop

@include('fleetany-web-reports::reports.filters.tires.maintenance')
...
<div class="mdl-grid demo-content">
	...
	@include('reports.gridview', [
    	'registers' => $registers,
    	'gridview' => [
    		'pageActive' => 'reports-tires-maintenance',
         	'sortFilters' => [
